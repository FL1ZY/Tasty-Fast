document.addEventListener("DOMContentLoaded", function() {
    ...
    t = jQuery, a = {
        ...
        stateBasket: function() {
            ...
            } else console.log("Заповніть параметри productSize та productPrice");
            return e.getSmartBasketMinState(o), c.click(function() {
                let r = e.getProducts() || {},
                    n = t(this).attr("data-sb-id-or-vendor-code");
                if (void 0 !== r[n]) {
                    let a = t(this).html();
                    return t(this).text("Товар вже в кошику"), t("body").append(e.alertBlock("alreadyAdded")), setTimeout(() => {
                        t(this).html(a)
                    }, 1500), !1
                } {
                    let i = {};
        ...
        commonResult: function(e, s, r) {
            let n = 0,
                ...
                }).text("Кошик порожній. Ви не додали жодного товару.").fadeOut(),
                l = t("<div>").attr({
        ...
        userForm: function() {
            let s = t("<div>").attr({
                ...
                i = t("<input>").attr({
                    class: "smart-basket__user-input ym-record-keys",
                    type: "text",
            ...
            let o = t("<div>").attr({
                ...
                }).mask(a.countryCode + "(000)000-00-0000");
            o.append(l);
            let c = t("<div>").attr({
                    class: "smart-basket__input-wrapper"
                }),
